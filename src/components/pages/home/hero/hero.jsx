  ...
  <section className="overflow-hidden text-white bg-black">
    <Container className="py-32 md:py-24">
      <div className="max-w-[592px] lg:max-w-[auto] lg:mb-9">
        ...
        />
        <div className="flex space-x-6 mt-9 sm:space-x-3">
          <Button className="xs:px-5" to={button1.url}>
            {button1.title}
          </Button>
          <Button className="xs:px-5" to={button2.url} theme="white">
            <SlackIcon className="mr-2.5 xs:mr-1.5" />
            {button2.title}
          </Button>
        </div>
      </div>
